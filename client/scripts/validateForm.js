...
export const validatePassword = (password) => {
    ...
    const message = status ? "" : "Please fulfill password conditions"

    return { status, minCharLimit, includesUpperCase, includesLowerCase, includesNumber, notContainsForbidden, message };
};
